...
def show_disclaimer():
    ...
    print(separator)
    print("By using this program, you accept that if you make decisions based on the results, and it is harmful to you, I am NOT liable for it.")
...
def print_results(result):
    ...
    print("💾 Source: Previous analysis (from database)" if result.get('from_cache') else "🔍 Source: Fresh analysis")
